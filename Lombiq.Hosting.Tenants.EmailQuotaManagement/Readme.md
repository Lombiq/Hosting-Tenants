...
With the help of this module, you can set restrictions regarding maximum email sent per tenant per month, if they are using one of the default email providers set configured using environment variables or the _appsettings.json_ file.
