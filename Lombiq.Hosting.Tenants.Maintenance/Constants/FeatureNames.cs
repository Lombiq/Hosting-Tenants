...
public static class FeatureNames
{
    ...
    public const string PurgeMediaCache = Maintenance + "." + nameof(PurgeMediaCache);
    ...
    public const string StaggeredTenantWakeUp = Maintenance + "." + nameof(StaggeredTenantWakeUp);
}
